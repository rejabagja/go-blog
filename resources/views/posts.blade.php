...
@section('container')
    ...
    @if ($posts->count()) {{-- jika collection post > 0 --}}
        {{-- hero latest article blog post --}}
        <div class="card mb-3">
            {{-- <img src="https://source.unsplash.com/1200x400?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}"> --}}
            <img src="https://picsum.photos/seed/{{ $posts[0]->category->name }}/1200/400" class="card-img-top" alt="{{ $posts[0]->category->name }}">
            ...
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <img src="https://picsum.photos/seed/{{ $post->category->name }}/500/400" class="card-img-top" alt="{{ $post->category->name }}">
                        <div class="card-body">
